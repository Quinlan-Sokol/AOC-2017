...
public class Day8 {
    ...
    {
        /*String[] instr = {"b inc 5 if a > 1",
"a inc 1 if b < 5",
"c dec -10 if a >= 1",
"c inc -20 if c == 10"};*/
        
        String[] instr = {"ioe dec 890 if qk > -10" ,
"gif inc -533 if qt <= 7" ,
"itw dec 894 if t != 0" ,
...
"ih dec 369 if ih == 1993"};
        ...
        {
            char[] array = instr[i].toCharArray();
            String reg = "";
        ...
        for(int i = 0; i < instr.length; i++)
        {
            ...
            switch(operation2){
                case ">":
                    if(registers.get(reg2) > Integer.parseInt(value2)){
                        condition = true;
                    }else{
                        condition = false;
                    }
            ...
            if(condition){
                ...
                if(operation.equals("inc")){
                    newValue = registers.get(reg) + Integer.parseInt(value);
                }
